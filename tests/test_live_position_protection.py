...
class Mt5BrokerTruthPreferenceTests(unittest.TestCase):
    ...
    def test_commands_mql_polls_persisted_order_commands(self) -> None:
        ...
        account_row = {"account_id": "MT5_ACCOUNT_ID_REQUIRED", "mode": "live", "status": "connected", "metadata": {}}
        command_row = {
            "command_id": "mt5cmd-1",
        ...
        self.assertEqual(payload["account_id"], "MT5_ACCOUNT_ID_REQUIRED")
