...
legacy_regex='^[a-f0-9]{12,}_(txt-postgres|mission-control-ui|mission-control-gateway|control-plane|market-data|risk-gateway|broker-adapter|ai-orchestrator|embeddings-service|mt5-bridge|execution-router)$'
