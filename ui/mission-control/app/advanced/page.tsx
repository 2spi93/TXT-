  ...
  return (
    <main className="shell txt-page-shell">
      <section className="panel txt-page-hero">
        ...
        <h1 className="title" style={{ fontSize: 34 }}>Outils de diagnostic avance</h1>
      ...
      <section className="grid" style={{ gridTemplateColumns: "repeat(3, minmax(0, 1fr))" }}>
        <article className="panel txt-topic-card">
          ...
          <Link href="/advanced/chart-auto-stability">Ouvrir la vue debug</Link>
        </article>
        <article className="panel txt-topic-card">
          ...
          <Link href="/advanced/predictor-calibration">Ouvrir la calibration</Link>
        </article>
        <article className="panel txt-topic-card">
          <div className="eyebrow">Execution Learning</div>
          <h2 style={{ margin: "8px 0", fontSize: 20 }}>Execution Gap Monitor</h2>
          ...
          <Link href="/advanced/reality-gap">Ouvrir la vue execution-gap</Link>
        </article>
