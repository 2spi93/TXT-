...
export function assertLiveOpsCriticalPayload(payload: unknown): LiveOpsCriticalPayload {
  ...
  if (
    ...
    && !["controlled-live-ramp-gate/v1", "controlled-live-ramp-gate/v1.1", "controlled-live-ramp-gate/v1.2", "controlled-live-ramp-gate/v1.3", "controlled-live-ramp-gate/v1.4", "controlled-live-ramp-gate/v1.5", "controlled-live-ramp-gate/v1.6", "controlled-live-ramp-gate/v1.7"].includes(String(controlledLiveRampGate.schema_version || ""))
  ) {
